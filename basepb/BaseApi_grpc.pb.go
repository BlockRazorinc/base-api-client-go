...
const (
	...
	BaseApi_GetNewFlashblockTransactionsStream_FullMethodName = "/BaseApi/GetNewFlashblockTransactionsStream"
)
...
type BaseApiClient interface {
	...
	GetNewFlashblockTransactionsStream(ctx context.Context, in *GetNewFlashblockTransactionsStreamRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[NewFlashblockTransaction], error)
}
...
func (c *baseApiClient) GetNewFlashblockTransactionsStream(ctx context.Context, in *GetNewFlashblockTransactionsStreamRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[NewFlashblockTransaction], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &BaseApi_ServiceDesc.Streams[2], BaseApi_GetNewFlashblockTransactionsStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[GetNewFlashblockTransactionsStreamRequest, NewFlashblockTransaction]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BaseApi_GetNewFlashblockTransactionsStreamClient = grpc.ServerStreamingClient[NewFlashblockTransaction]
...
type BaseApiServer interface {
	...
	GetNewFlashblockTransactionsStream(*GetNewFlashblockTransactionsStreamRequest, grpc.ServerStreamingServer[NewFlashblockTransaction]) error
...
func (UnimplementedBaseApiServer) GetNewFlashblockTransactionsStream(*GetNewFlashblockTransactionsStreamRequest, grpc.ServerStreamingServer[NewFlashblockTransaction]) error {
	return status.Errorf(codes.Unimplemented, "method GetNewFlashblockTransactionsStream not implemented")
}
...
func _BaseApi_GetNewFlashblockTransactionsStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetNewFlashblockTransactionsStreamRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(BaseApiServer).GetNewFlashblockTransactionsStream(m, &grpc.GenericServerStream[GetNewFlashblockTransactionsStreamRequest, NewFlashblockTransaction]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BaseApi_GetNewFlashblockTransactionsStreamServer = grpc.ServerStreamingServer[NewFlashblockTransaction]
...
var BaseApi_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "GetNewFlashblockTransactionsStream",
			Handler:       _BaseApi_GetNewFlashblockTransactionsStream_Handler,
			ServerStreams: true,
		},
	},
